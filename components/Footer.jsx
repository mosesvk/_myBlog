  ...
  return (
    <div className='bg-stone-800 text-white p-10 flex flex-col md:flex-row justify-around'>
      ...
      <div className='flex flex-row'>
        <a href='https://www.linkedin.com/in/mosesvk/' className='text-3xl hover:text-blue-400 duration-300'>
          <FaLinkedinIn />
        </a>
        <a href='https://www.youtube.com/channel/UChlB6LMekxCh917bjumDcCA' className='text-3xl mx-5 hover:text-blue-400 duration-300'>
          <FaYoutube />
        </a>
        <a href='https://www.facebook.com/profile.php?id=100004199235959' className='text-3xl hover:text-blue-400 duration-300'>
          <FaFacebookF />
        </a>
      </div>
    </div>
